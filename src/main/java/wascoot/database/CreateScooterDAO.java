...
*/
     ...
     */
            private static final String STATEMENT = "INSERT INTO public.scooter (date_of_purchase, km_traveled, model,remaining_battery_life) VALUES (?, ?, ?, ? ,?)";
 ...
 +     */
    ...
    protected final void doAccess() throws SQLException {
                            ...
                            pstmt.setInt(1, scooter.getDateofPurchase());
                            pstmt.setInt(2, scooter.getKmTraveled());
                            pstmt.setString(3, scooter.getModel());
                            pstmt.setString(4, scooter.getRemainingBatteryLife());

                        pstmt.execute();

                                  LOGGER.info("Scooter successfully stored in the database.");
                        } finally {
                            if (pstmt != null) {
                                    pstmt.close();
                                }
