...
+    public ListModelRR(HttpServletRequest req, HttpServletResponse res, Connection con) {
        +        super(Actions.GET_ALL_Models,req, res, con);
        +    }
+
        +    @Override
+    protected void doServe() throws IOException {
        ...
        +
            ...
            +            el = new ModelDatabase(con).access().getOutputParam();
            +
                    +            if (el != null) {
